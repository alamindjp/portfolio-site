...
import redSea1 from '../Assets/webImage/RedSea1.png'
import redSea2 from '../Assets/webImage/RedSea2.png'
import redSea3 from '../Assets/webImage/RedSea3.png'
import redSea4 from '../Assets/webImage/RedSea1.png'
        ...
        <div>
            ...
            <div className="container mx-auto card mt-20">
                <div className='grid grid-cols-1 md:grid-cols-2 gap-10'>
                    <figure><img className='card opacity-90' src={redSea1} alt="Shoes" /></figure>
                    <figure><img className='card opacity-90' src={redSea2} alt="Shoes" /></figure>
                    <figure><img className='card opacity-90' src={redSea3} alt="Shoes" /></figure>
                    <figure><img className='card opacity-90' src={redSea4} alt="Shoes" /></figure>
                </div>
