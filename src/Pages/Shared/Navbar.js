            ...
            <div className="container navbar mx-auto">
                ...
                <div className="navbar-center hidden lg:flex">
                    <ul className="menu menu-horizontal p-0">
                        <li className='hover:bg-bgSemi rounded-lg'><a href='/#home'>Home</a></li>
                        <li className='hover:bg-bgSemi rounded-lg'><a href='/#about'>About</a></li>
                        <li className='hover:bg-bgSemi rounded-lg'><a href='/#contact'>Contact</a></li>
                    </ul>
                </div>
            </div>
       </div>
